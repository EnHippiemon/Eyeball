...
struct Z_CompiledInDeferFile_FID_Users_albin_samuelsson_Desktop_GitHub_Eyeball_Eyeball_Source_Eyeball_Entities_EyeEntityGrasshopper_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AEyeEntityGrasshopper, AEyeEntityGrasshopper::StaticClass, TEXT("AEyeEntityGrasshopper"), &Z_Registration_Info_UClass_AEyeEntityGrasshopper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEyeEntityGrasshopper), 1515599336U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_albin_samuelsson_Desktop_GitHub_Eyeball_Eyeball_Source_Eyeball_Entities_EyeEntityGrasshopper_h_1653145145(TEXT("/Script/Eyeball"),
